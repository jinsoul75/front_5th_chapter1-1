...
`,I=t=>{const{profileImage:e,author:s,timeAgo:n,content:o,id:l}=t;return`
...
`,d=({label:t,id:e,value:s,type:n="text"})=>`
  <div class="mb-4">
...
`,i=()=>{const e=window.location.pathname.replace(c,"")||"/";let s="";e==="/"?s=E():e==="/profile"?s=A({user:S()}):e==="/login"?s=B():s=O(),document.getElementById("root").innerHTML=s,p(e)};window.addEventListener("load",i);window.addEventListener("popstate",i);
